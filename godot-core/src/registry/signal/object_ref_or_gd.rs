...
///
/// [`ObjectRefOrGd`](Self) solves this by explicitly handling each category in a different way, but still resulting
...
/// ```
/// # use godot::register::ObjectRefOrGd;
/// # use godot::obj::Gd;
/// fn o_minus<Declarer, C>(obj: &Gd<C>)
/// where
///     C: ObjectRefOrGd<Declarer>,
/// {
...
pub trait ObjectRefOrGd<Declarer>: GodotClass {
...
#[allow(clippy::needless_lifetimes)] // False positive.
impl<T: GodotClass<Declarer = DeclEngine>> ObjectRefOrGd<DeclEngine> for T {
...
#[allow(clippy::needless_lifetimes)] // False positive.
impl<T: WithBaseField> ObjectRefOrGd<DeclUser> for T {
