...
/// for [`TypedRid<T>`](crate::rid::TypedRid) when working with server-internal resources.
pub trait TaggedRid: Copy + Clone {}

// ══════════════════════════════════════════════════════════════════════════════════════════════════
// RenderingServer markers
// ══════════════════════════════════════════════════════════════════════════════════════════════════

/// Marker for RIDs returned by [`RenderingServer::canvas_create()`](crate::classes::RenderingServer::canvas_create).
///
/// Represents a canvas rendering context (not to be confused with [`CanvasItem`](crate::classes::CanvasItem)).
pub enum TagCanvas {}

/// Marker for RIDs returned by [`RenderingServer::scenario_create()`](crate::classes::RenderingServer::scenario_create).
///
/// Represents a 3D rendering scenario/world container.
pub enum TagScenario {}

/// Marker for RIDs returned by [`RenderingServer::instance_create()`](crate::classes::RenderingServer::instance_create)
/// and [`RenderingServer::instance_create2()`](crate::classes::RenderingServer::instance_create2).
///
/// Represents a rendering instance in a scenario.
pub enum TagInstance {}
impl TaggedRid for TagInstance {}

/// Marker for RIDs returned by [`RenderingServer::skeleton_create()`](crate::classes::RenderingServer::skeleton_create).
///
/// Represents a skeleton for mesh deformation (server-side).
/// Note: Different from the `Skeleton3D` scene tree node.
pub enum TagSkeleton {}
impl TaggedRid for TagSkeleton {}

/// Marker for RIDs returned by [`RenderingServer::occluder_create()`](crate::classes::RenderingServer::occluder_create).
///
/// Represents an occlusion culling occluder.
pub enum TagOccluder {}
impl TaggedRid for TagOccluder {}

/// Marker for RIDs returned by [`RenderingServer::lightmap_create()`].
///
/// Represents a lightmap resource.
///
/// [`RenderingServer::lightmap_create()`]: crate::classes::RenderingServer::lightmap_create
...
///
/// [`RenderingServer::compositor_create()`]: crate::classes::RenderingServer::compositor_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`RenderingServer::compositor_effect_create()`]: crate::classes::RenderingServer::compositor_effect_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`RenderingServer::viewport_create()`]: crate::classes::RenderingServer::viewport_create
...
///
/// [`PhysicsServer2D::space_create()`]: crate::classes::PhysicsServer2D::space_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer2D::area_create()`]: crate::classes::PhysicsServer2D::area_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer2D::body_create()`]: crate::classes::PhysicsServer2D::body_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer2D::joint_create()`]: crate::classes::PhysicsServer2D::joint_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
/// Note: Different from any scene tree node.
///
/// [`PhysicsServer3D::space_create()`]: crate::classes::PhysicsServer3D::space_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer3D::area_create()`]: crate::classes::PhysicsServer3D::area_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer3D::body_create()`]: crate::classes::PhysicsServer3D::body_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer3D::soft_body_create()`]: crate::classes::PhysicsServer3D::soft_body_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`PhysicsServer3D::joint_create()`]: crate::classes::PhysicsServer3D::joint_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::map_create()`]: crate::classes::NavigationServer2D::map_create
/// [`NavigationServer3D::map_create()`]: crate::classes::NavigationServer3D::map_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::region_create()`]: crate::classes::NavigationServer2D::region_create
/// [`NavigationServer3D::region_create()`]: crate::classes::NavigationServer3D::region_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::link_create()`]: crate::classes::NavigationServer2D::link_create
/// [`NavigationServer3D::link_create()`]: crate::classes::NavigationServer3D::link_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::agent_create()`]: crate::classes::NavigationServer2D::agent_create
/// [`NavigationServer3D::agent_create()`]: crate::classes::NavigationServer3D::agent_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::obstacle_create()`]: crate::classes::NavigationServer2D::obstacle_create
/// [`NavigationServer3D::obstacle_create()`]: crate::classes::NavigationServer3D::obstacle_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
///
/// [`NavigationServer2D::source_geometry_parser_create()`]: crate::classes::NavigationServer2D::source_geometry_parser_create
/// [`NavigationServer3D::source_geometry_parser_create()`]: crate::classes::NavigationServer3D::source_geometry_parser_create
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
...
/// Note: No corresponding Godot class exists.
///
/// [`TextServer::create_shaped_text()`]: crate::classes::TextServer::create_shaped_text
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
