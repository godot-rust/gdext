...
///
/// Refer to [`Signal::to_future`](crate::builtin::Signal::to_future) and [`Signal::to_try_future`](crate::builtin::Signal::to_try_future)
...
// uses a deferred callable to poll the associated future.
