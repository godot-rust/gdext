...
/// [`TypedSignal`][crate::signal::TypedSignal] and [`ConnectBuilder`][crate::signal::ConnectBuilder].
///
...
impl ConnectHandle {
    ...
    /// - ... the emitter object managed by this handle is not valid -- e.g. if the object has been freed.
