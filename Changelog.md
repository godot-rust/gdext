...
- 🔺 Pass-by-ref for non-`Copy` builtins (frontend) ([#900](https://github.com/godot-rust/gdext/pull/900))
...
- `AsObjectArg<T>` is now implemented for `&mut Gd<T>` ([#847](https://github.com/godot-rust/gdext/pull/847))
...
- Add godot-convert impl for const u8 pointers ([#866](https://github.com/godot-rust/gdext/pull/866))
...
- Unicode `ClassName::new_cached()`; adjust test ([#899](https://github.com/godot-rust/gdext/pull/899))
...
- CI: skip `notify-docs` job when running in a fork ([#945](https://github.com/godot-rust/gdext/pull/945))
- Workflows/full-ci: allow manually triggering the workflow (mostly useful for forks) ([#933](https://github.com/godot-rust/gdext/pull/933))
- Require `AsObjectArg` pass-by-ref, consistent with `AsArg` ([#947](https://github.com/godot-rust/gdext/pull/947))
