...
/// ## Export tool button
///
/// If you need to create a clickable inspector button on your tool class, you can use [`PhantomVar<Callable>`](../prelude/struct.PhantomVar.html) with `#[export_tool_button]`.
...
///
/// Note: Callables generated by `#[export_tool_button]` become invalid after hot reload.
/// Keeping references to them after hot reloading (for example by using tool script or other GDExtension)
/// is unsound and will crash the editor.
///
/// See also in Godot docs:
