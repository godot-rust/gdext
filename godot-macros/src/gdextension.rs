...
///
/// Dependencies shouldn't generate any code related to library registration (this being wasm preregistration, entry point, hotreload workaround),
...
fn is_dependency_gdextension(implementor_ty: &venial::TypeExpr) -> bool {
    ...
    extract_typename(implementor_ty).is_some_and(|segment| segment.ident != main_gdextension)
}
