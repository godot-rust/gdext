...
pub type get_godot_version =
    unsafe extern "C" fn(r_godot_version: *mut GDExtensionGodotVersion) -> ();
pub type get_godot_version2 =
    unsafe extern "C" fn(r_godot_version: *mut GDExtensionGodotVersion2) -> ();
pub type mem_alloc = unsafe extern "C" fn(p_bytes: usize) -> *mut ();
pub type mem_realloc = unsafe extern "C" fn(p_ptr: *mut (), p_bytes: usize) -> *mut ();
pub type mem_free = unsafe extern "C" fn(p_ptr: *mut ()) -> ();
pub type mem_alloc2 = unsafe extern "C" fn(p_bytes: usize, p_pad_align: GDExtensionBool) -> *mut ();
pub type mem_realloc2 =
    unsafe extern "C" fn(p_ptr: *mut (), p_bytes: usize, p_pad_align: GDExtensionBool) -> *mut ();
pub type mem_free2 = unsafe extern "C" fn(p_ptr: *mut (), p_pad_align: GDExtensionBool) -> ();
pub type print_error = unsafe extern "C" fn(
...
pub type print_error_with_message = unsafe extern "C" fn(
    p_description: *const std::ffi::c_char,
...
pub type print_warning = unsafe extern "C" fn(
    p_description: *const std::ffi::c_char,
    p_function: *const std::ffi::c_char,
    p_file: *const std::ffi::c_char,
    p_line: i32,
...
pub type print_warning_with_message = unsafe extern "C" fn(
    p_description: *const std::ffi::c_char,
    p_message: *const std::ffi::c_char,
    p_function: *const std::ffi::c_char,
    p_file: *const std::ffi::c_char,
...
pub type print_script_error = unsafe extern "C" fn(
    p_description: *const std::ffi::c_char,
    p_function: *const std::ffi::c_char,
    p_file: *const std::ffi::c_char,
    p_line: i32,
...
pub type print_script_error_with_message = unsafe extern "C" fn(
    p_description: *const std::ffi::c_char,
    p_message: *const std::ffi::c_char,
    p_function: *const std::ffi::c_char,
    p_file: *const std::ffi::c_char,
...
pub type get_native_struct_size =
    unsafe extern "C" fn(p_name: GDExtensionConstStringNamePtr) -> u64;
pub type variant_new_copy = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedVariantPtr,
    p_src: GDExtensionConstVariantPtr,
) -> ();
pub type variant_new_nil = unsafe extern "C" fn(r_dest: GDExtensionUninitializedVariantPtr) -> ();
pub type variant_destroy = unsafe extern "C" fn(p_self: GDExtensionVariantPtr) -> ();
pub type variant_call = unsafe extern "C" fn(
...
pub type variant_call_static = unsafe extern "C" fn(
...
pub type variant_evaluate = unsafe extern "C" fn(
...
pub type variant_set = unsafe extern "C" fn(
    p_self: GDExtensionVariantPtr,
    p_key: GDExtensionConstVariantPtr,
    p_value: GDExtensionConstVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_set_named = unsafe extern "C" fn(
    p_self: GDExtensionVariantPtr,
    p_key: GDExtensionConstStringNamePtr,
    p_value: GDExtensionConstVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_set_keyed = unsafe extern "C" fn(
    p_self: GDExtensionVariantPtr,
    p_key: GDExtensionConstVariantPtr,
    p_value: GDExtensionConstVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_set_indexed = unsafe extern "C" fn(
    p_self: GDExtensionVariantPtr,
    p_index: GDExtensionInt,
    p_value: GDExtensionConstVariantPtr,
    r_valid: *mut GDExtensionBool,
...
pub type variant_get = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_key: GDExtensionConstVariantPtr,
    r_ret: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_get_named = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_key: GDExtensionConstStringNamePtr,
    r_ret: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_get_keyed = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_key: GDExtensionConstVariantPtr,
    r_ret: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_get_indexed = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_index: GDExtensionInt,
    r_ret: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
...
pub type variant_iter_init = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    r_iter: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> GDExtensionBool;
pub type variant_iter_next = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    r_iter: GDExtensionVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> GDExtensionBool;
pub type variant_iter_get = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    r_iter: GDExtensionVariantPtr,
    r_ret: GDExtensionUninitializedVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> ();
pub type variant_hash = unsafe extern "C" fn(p_self: GDExtensionConstVariantPtr) -> GDExtensionInt;
pub type variant_recursive_hash = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_recursion_count: GDExtensionInt,
) -> GDExtensionInt;
pub type variant_hash_compare = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_other: GDExtensionConstVariantPtr,
) -> GDExtensionBool;
pub type variant_booleanize =
    unsafe extern "C" fn(p_self: GDExtensionConstVariantPtr) -> GDExtensionBool;
pub type variant_duplicate = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    r_ret: GDExtensionVariantPtr,
    p_deep: GDExtensionBool,
) -> ();
pub type variant_stringify =
    unsafe extern "C" fn(p_self: GDExtensionConstVariantPtr, r_ret: GDExtensionStringPtr) -> ();
pub type variant_get_type =
    unsafe extern "C" fn(p_self: GDExtensionConstVariantPtr) -> GDExtensionVariantType;
pub type variant_has_method = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_method: GDExtensionConstStringNamePtr,
) -> GDExtensionBool;
pub type variant_has_member = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_member: GDExtensionConstStringNamePtr,
) -> GDExtensionBool;
pub type variant_has_key = unsafe extern "C" fn(
    p_self: GDExtensionConstVariantPtr,
    p_key: GDExtensionConstVariantPtr,
    r_valid: *mut GDExtensionBool,
) -> GDExtensionBool;
pub type variant_get_object_instance_id =
    unsafe extern "C" fn(p_self: GDExtensionConstVariantPtr) -> GDObjectInstanceID;
pub type variant_get_type_name = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    r_name: GDExtensionUninitializedStringPtr,
) -> ();
pub type variant_can_convert = unsafe extern "C" fn(
    p_from: GDExtensionVariantType,
    p_to: GDExtensionVariantType,
) -> GDExtensionBool;
pub type variant_can_convert_strict = unsafe extern "C" fn(
    p_from: GDExtensionVariantType,
    p_to: GDExtensionVariantType,
) -> GDExtensionBool;
pub type get_variant_from_type_constructor =
    unsafe extern "C" fn(
        p_type: GDExtensionVariantType,
    ) -> GDExtensionVariantFromTypeConstructorFunc;
pub type get_variant_to_type_constructor =
    unsafe extern "C" fn(
        p_type: GDExtensionVariantType,
    ) -> GDExtensionTypeFromVariantConstructorFunc;
pub type variant_get_ptr_internal_getter =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionVariantGetInternalPtrFunc;
pub type variant_get_ptr_operator_evaluator =
    unsafe extern "C" fn(
...
pub type variant_get_ptr_builtin_method = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_method: GDExtensionConstStringNamePtr,
    p_hash: GDExtensionInt,
) -> GDExtensionPtrBuiltInMethod;
pub type variant_get_ptr_constructor = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_constructor: i32,
) -> GDExtensionPtrConstructor;
pub type variant_get_ptr_destructor =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrDestructor;
pub type variant_construct = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
...
pub type variant_get_ptr_setter = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_member: GDExtensionConstStringNamePtr,
) -> GDExtensionPtrSetter;
pub type variant_get_ptr_getter = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_member: GDExtensionConstStringNamePtr,
) -> GDExtensionPtrGetter;
pub type variant_get_ptr_indexed_setter =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrIndexedSetter;
pub type variant_get_ptr_indexed_getter =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrIndexedGetter;
pub type variant_get_ptr_keyed_setter =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrKeyedSetter;
pub type variant_get_ptr_keyed_getter =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrKeyedGetter;
pub type variant_get_ptr_keyed_checker =
    unsafe extern "C" fn(p_type: GDExtensionVariantType) -> GDExtensionPtrKeyedChecker;
pub type variant_get_constant_value = unsafe extern "C" fn(
    p_type: GDExtensionVariantType,
    p_constant: GDExtensionConstStringNamePtr,
    r_ret: GDExtensionUninitializedVariantPtr,
) -> ();
pub type variant_get_ptr_utility_function = unsafe extern "C" fn(
    p_function: GDExtensionConstStringNamePtr,
    p_hash: GDExtensionInt,
) -> GDExtensionPtrUtilityFunction;
pub type string_new_with_latin1_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const std::ffi::c_char,
) -> ();
pub type string_new_with_utf8_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const std::ffi::c_char,
) -> ();
pub type string_new_with_utf16_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const char16_t,
) -> ();
pub type string_new_with_utf32_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const char32_t,
) -> ();
pub type string_new_with_wide_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const wchar_t,
) -> ();
pub type string_new_with_latin1_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const std::ffi::c_char,
    p_size: GDExtensionInt,
) -> ();
pub type string_new_with_utf8_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const std::ffi::c_char,
    p_size: GDExtensionInt,
) -> ();
pub type string_new_with_utf8_chars_and_len2 = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const std::ffi::c_char,
    p_size: GDExtensionInt,
) -> GDExtensionInt;
pub type string_new_with_utf16_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const char16_t,
    p_char_count: GDExtensionInt,
) -> ();
pub type string_new_with_utf16_chars_and_len2 = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const char16_t,
    p_char_count: GDExtensionInt,
    p_default_little_endian: GDExtensionBool,
) -> GDExtensionInt;
pub type string_new_with_utf32_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const char32_t,
    p_char_count: GDExtensionInt,
) -> ();
pub type string_new_with_wide_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringPtr,
    p_contents: *const wchar_t,
    p_char_count: GDExtensionInt,
) -> ();
pub type string_to_latin1_chars = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    r_text: *mut std::ffi::c_char,
    p_max_write_length: GDExtensionInt,
) -> GDExtensionInt;
pub type string_to_utf8_chars = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    r_text: *mut std::ffi::c_char,
    p_max_write_length: GDExtensionInt,
) -> GDExtensionInt;
pub type string_to_utf16_chars = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    r_text: *mut char16_t,
    p_max_write_length: GDExtensionInt,
) -> GDExtensionInt;
pub type string_to_utf32_chars = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    r_text: *mut char32_t,
    p_max_write_length: GDExtensionInt,
) -> GDExtensionInt;
pub type string_to_wide_chars = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    r_text: *mut wchar_t,
    p_max_write_length: GDExtensionInt,
) -> GDExtensionInt;
pub type string_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_index: GDExtensionInt) -> *mut char32_t;
pub type string_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstStringPtr,
    p_index: GDExtensionInt,
) -> *const char32_t;
pub type string_operator_plus_eq_string =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_b: GDExtensionConstStringPtr) -> ();
pub type string_operator_plus_eq_char =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_b: char32_t) -> ();
pub type string_operator_plus_eq_cstr =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_b: *const std::ffi::c_char) -> ();
pub type string_operator_plus_eq_wcstr =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_b: *const wchar_t) -> ();
pub type string_operator_plus_eq_c32str =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_b: *const char32_t) -> ();
pub type string_resize =
    unsafe extern "C" fn(p_self: GDExtensionStringPtr, p_resize: GDExtensionInt) -> GDExtensionInt;
pub type string_name_new_with_latin1_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringNamePtr,
    p_contents: *const std::ffi::c_char,
    p_is_static: GDExtensionBool,
) -> ();
pub type string_name_new_with_utf8_chars = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringNamePtr,
    p_contents: *const std::ffi::c_char,
) -> ();
pub type string_name_new_with_utf8_chars_and_len = unsafe extern "C" fn(
    r_dest: GDExtensionUninitializedStringNamePtr,
    p_contents: *const std::ffi::c_char,
    p_size: GDExtensionInt,
) -> ();
pub type xml_parser_open_buffer = unsafe extern "C" fn(
    p_instance: GDExtensionObjectPtr,
    p_buffer: *const u8,
    p_size: usize,
) -> GDExtensionInt;
pub type file_access_store_buffer =
    unsafe extern "C" fn(p_instance: GDExtensionObjectPtr, p_src: *const u8, p_length: u64) -> ();
pub type file_access_get_buffer = unsafe extern "C" fn(
    p_instance: GDExtensionConstObjectPtr,
    p_dst: *mut u8,
    p_length: u64,
) -> u64;
pub type image_ptrw = unsafe extern "C" fn(p_instance: GDExtensionObjectPtr) -> *mut u8;
pub type image_ptr = unsafe extern "C" fn(p_instance: GDExtensionObjectPtr) -> *const u8;
pub type worker_thread_pool_add_native_group_task = unsafe extern "C" fn(
    p_instance: GDExtensionObjectPtr,
...
pub type worker_thread_pool_add_native_task = unsafe extern "C" fn(
    p_instance: GDExtensionObjectPtr,
...
pub type packed_byte_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> *mut u8;
pub type packed_byte_array_operator_index_const =
    unsafe extern "C" fn(p_self: GDExtensionConstTypePtr, p_index: GDExtensionInt) -> *const u8;
pub type packed_float32_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> *mut f32;
pub type packed_float32_array_operator_index_const =
    unsafe extern "C" fn(p_self: GDExtensionConstTypePtr, p_index: GDExtensionInt) -> *const f32;
pub type packed_float64_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> *mut f64;
pub type packed_float64_array_operator_index_const =
    unsafe extern "C" fn(p_self: GDExtensionConstTypePtr, p_index: GDExtensionInt) -> *const f64;
pub type packed_int32_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> *mut i32;
pub type packed_int32_array_operator_index_const =
    unsafe extern "C" fn(p_self: GDExtensionConstTypePtr, p_index: GDExtensionInt) -> *const i32;
pub type packed_int64_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> *mut i64;
pub type packed_int64_array_operator_index_const =
    unsafe extern "C" fn(p_self: GDExtensionConstTypePtr, p_index: GDExtensionInt) -> *const i64;
pub type packed_string_array_operator_index = unsafe extern "C" fn(
    p_self: GDExtensionTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionStringPtr;
pub type packed_string_array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionStringPtr;
pub type packed_vector2_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> GDExtensionTypePtr;
pub type packed_vector2_array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionTypePtr;
pub type packed_vector3_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> GDExtensionTypePtr;
pub type packed_vector3_array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionTypePtr;
pub type packed_vector4_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> GDExtensionTypePtr;
pub type packed_vector4_array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionTypePtr;
pub type packed_color_array_operator_index =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_index: GDExtensionInt) -> GDExtensionTypePtr;
pub type packed_color_array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionTypePtr;
pub type array_operator_index = unsafe extern "C" fn(
    p_self: GDExtensionTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionVariantPtr;
pub type array_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_index: GDExtensionInt,
) -> GDExtensionVariantPtr;
pub type array_ref =
    unsafe extern "C" fn(p_self: GDExtensionTypePtr, p_from: GDExtensionConstTypePtr) -> ();
pub type array_set_typed = unsafe extern "C" fn(
    p_self: GDExtensionTypePtr,
    p_type: GDExtensionVariantType,
    p_class_name: GDExtensionConstStringNamePtr,
    p_script: GDExtensionConstVariantPtr,
) -> ();
pub type dictionary_operator_index = unsafe extern "C" fn(
    p_self: GDExtensionTypePtr,
    p_key: GDExtensionConstVariantPtr,
) -> GDExtensionVariantPtr;
pub type dictionary_operator_index_const = unsafe extern "C" fn(
    p_self: GDExtensionConstTypePtr,
    p_key: GDExtensionConstVariantPtr,
) -> GDExtensionVariantPtr;
pub type dictionary_set_typed = unsafe extern "C" fn(
    p_self: GDExtensionTypePtr,
...
pub type object_method_bind_call = unsafe extern "C" fn(
...
pub type object_method_bind_ptrcall = unsafe extern "C" fn(
    p_method_bind: GDExtensionMethodBindPtr,
    p_instance: GDExtensionObjectPtr,
    p_args: *const GDExtensionConstTypePtr,
    r_ret: GDExtensionTypePtr,
) -> ();
pub type object_destroy = unsafe extern "C" fn(p_o: GDExtensionObjectPtr) -> ();
pub type global_get_singleton =
    unsafe extern "C" fn(p_name: GDExtensionConstStringNamePtr) -> GDExtensionObjectPtr;
pub type object_get_instance_binding = unsafe extern "C" fn(
    p_o: GDExtensionObjectPtr,
    p_token: *mut (),
    p_callbacks: *const GDExtensionInstanceBindingCallbacks,
) -> *mut ();
pub type object_set_instance_binding = unsafe extern "C" fn(
    p_o: GDExtensionObjectPtr,
    p_token: *mut (),
    p_binding: *mut (),
    p_callbacks: *const GDExtensionInstanceBindingCallbacks,
) -> ();
pub type object_free_instance_binding =
    unsafe extern "C" fn(p_o: GDExtensionObjectPtr, p_token: *mut ()) -> ();
pub type object_set_instance = unsafe extern "C" fn(
    p_o: GDExtensionObjectPtr,
    p_classname: GDExtensionConstStringNamePtr,
    p_instance: GDExtensionClassInstancePtr,
) -> ();
pub type object_get_class_name = unsafe extern "C" fn(
    p_object: GDExtensionConstObjectPtr,
    p_library: GDExtensionClassLibraryPtr,
    r_class_name: GDExtensionUninitializedStringNamePtr,
) -> GDExtensionBool;
pub type object_cast_to = unsafe extern "C" fn(
    p_object: GDExtensionConstObjectPtr,
    p_class_tag: *mut (),
) -> GDExtensionObjectPtr;
pub type object_get_instance_from_id =
    unsafe extern "C" fn(p_instance_id: GDObjectInstanceID) -> GDExtensionObjectPtr;
pub type object_get_instance_id =
    unsafe extern "C" fn(p_object: GDExtensionConstObjectPtr) -> GDObjectInstanceID;
pub type object_has_script_method = unsafe extern "C" fn(
    p_object: GDExtensionConstObjectPtr,
    p_method: GDExtensionConstStringNamePtr,
) -> GDExtensionBool;
pub type object_call_script_method = unsafe extern "C" fn(
    p_object: GDExtensionObjectPtr,
    p_method: GDExtensionConstStringNamePtr,
    p_args: *const GDExtensionConstVariantPtr,
    p_argument_count: GDExtensionInt,
...
pub type classdb_register_extension_class_property = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
...
pub type classdb_register_extension_class_property_indexed = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
    p_info: *const GDExtensionPropertyInfo,
    p_setter: GDExtensionConstStringNamePtr,
...
pub type classdb_register_extension_class_property_group = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
    p_group_name: GDExtensionConstStringPtr,
    p_prefix: GDExtensionConstStringPtr,
) -> ();
pub type classdb_register_extension_class_property_subgroup = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
    p_subgroup_name: GDExtensionConstStringPtr,
    p_prefix: GDExtensionConstStringPtr,
) -> ();
pub type classdb_register_extension_class_signal = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
...
pub type classdb_unregister_extension_class = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_class_name: GDExtensionConstStringNamePtr,
) -> ();
pub type get_library_path = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    r_path: GDExtensionUninitializedStringPtr,
) -> ();
pub type editor_add_plugin =
    unsafe extern "C" fn(p_class_name: GDExtensionConstStringNamePtr) -> ();
pub type editor_remove_plugin =
    unsafe extern "C" fn(p_class_name: GDExtensionConstStringNamePtr) -> ();
pub type editor_help_load_xml_from_utf8_chars =
    unsafe extern "C" fn(p_data: *const std::ffi::c_char) -> ();
pub type editor_help_load_xml_from_utf8_chars_and_len =
    unsafe extern "C" fn(p_data: *const std::ffi::c_char, p_size: GDExtensionInt) -> ();
pub type editor_register_get_classes_used_callback = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
    p_callback: GDExtensionEditorGetClassesUsedCallback,
) -> ();
pub type register_main_loop_callbacks = unsafe extern "C" fn(
    p_library: GDExtensionClassLibraryPtr,
