...
impl ApiLevel {
    #[deprecated = "`InitLevel::Servers` has been renamed to `ApiLevel::Server`"]
    #[allow(non_upper_case_globals)]
    pub const Servers: Self = ApiLevel::Server;

    #[doc(hidden)]
    pub fn from_sys(level: crate::GDExtensionInitializationLevel) -> Self {
        match level {
            crate::GDEXTENSION_INITIALIZATION_CORE => Self::Core,
            crate::GDEXTENSION_INITIALIZATION_SERVERS => Self::Server,
    ...
    pub fn to_sys(self) -> crate::GDExtensionInitializationLevel {
        match self {
            ...
            Self::Server => crate::GDEXTENSION_INITIALIZATION_SERVERS,
...
#[inline]
pub unsafe fn load_class_method_table(api_level: ApiLevel) {
